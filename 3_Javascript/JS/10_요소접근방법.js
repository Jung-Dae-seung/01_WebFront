...
// 올라온 키가 "Enter"키 이면 readValue() 호출

// keyup : 눌러지던 키가 떼어졌을때
// keydwn : 키가 눌러졌을때 ( + 꾹 누르고 있으면 계속 인식됨)
document.querySelector("#user-input").addEventListener('keyup', function(event) {
  // event : 이벤트 객체(발생한 이벤트 정보를 담김)
